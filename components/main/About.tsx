            ...
            <div className="flex flex-col items-center justify-start relative md:mt-[90px] lg:mt-12 z-[20] w-auto h-auto">
                <InView triggerOnce={false}>
                    {({ inView, ref }) => (
                        ...
                        >
                            <img src="/lais.png" alt="profile" width={250} />
                        </motion.div>
                    )}
                </InView>
                    ...
                    {({ inView, ref }) => (
                        ...
                        >
                            <h1 className="Welcome-text text-[16px] w-full text-justify">
                                Engenheira de Software e Desenvolvedora Full Stack (React, Node, Django). 
                                Especialista em análise de dados com Python e Power BI e gestora de projetos na 
                                Enactus. Focada em arquitetura de software, liderança técnica e resultados 
                                estratégicos. Disponível para parcerias freelancer.
                            </h1>
                        </motion.div>
                    )}
                </InView>
